...
if __name__ == "__main__":
    try:
        client_thread = FF_CLIENT(id="5278177994", password="706CBF5E970EC29B635E34E875BBC6F8989B7B16A630804E5894F562324AF9D8")
        client_thread.start()
    except Exception as e:
        logging.error(f"Error occurred: {e}")

        client_thread = FF_CLIENT(id="5278177999", password="B03A4B43C4A825C919A3336BF5C7FAF1156FFE9AECD07159AE46EACBFB58116F")
        client_thread.start()
    except Exception as e:
        logging.error(f"Error occurred: {e}")
